...
개인의 수입과 지출을 체계적으로 관리할 수 있는 웹 기반 가계부 애플리케이션 
HTML, CSS, JavaScript만을 사용하여 개발된 클라이언트 사이드 애플리케이션으로, 별도의 서버나 데이터베이스 없이 브라우저의 로컬 스토리지를 활용하여 데이터를 저장
...
**순수 HTML, CSS, JavaScript**로 개발되어 별도의 패키지 설치가 필요하지 않음
